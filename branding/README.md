...
transparent web exports. The launcher uses a white e-logo on `#CB4D49`. Its
separate `ic_launcher_brand_foreground` provides the splash's white e-logo on
its unchanged black background. Replace `logo-e.svg` and rerun this command
